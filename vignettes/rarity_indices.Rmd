...
![Rarity indices and corresponding functions.](figures/outlier_scheme.png)
...
Using `outlieR` distinctiveness values can be computed using function `distinctiveness_stack()`:
