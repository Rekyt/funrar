...
If your site-species matrix is big, it likely contains a lot of zeroes, because it is very rare that all species are present at all sites when looking at thousands of species.
...
`funrar` lets you use sparse matrices directly using a function implemented in the `Matrix` package. When your matrix is filled with 0s it can be quicker to use sparse matrices.
